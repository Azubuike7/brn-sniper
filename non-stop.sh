...
EXECUTOR_MAX_L3_GAS_PRICE=950000
EXECUTOR_PROCESS_BIDS_API_INTERVAL_SEC=0.1
EXECUTOR_MIN_BALANCE_THRESHOLD_ETH=0
EXECUTOR_ENABLE_BATCH_BIDDING=true
EXECUTOR_MAX_BATCH_SIZE=100
EXECUTOR_ORDER_PROCESS_PARALLELISM=100
EXECUTOR_OLD_ORDER_EXECUTION_WINDOW_SEC=600
EXECUTOR_PROCESS_PENDING_ORDERS_FROM_API=true
EXECUTOR_PROCESS_ORDERS_API_ENABLED=true
export EXECUTOR_API_SCAN_INTERVAL_SEC=10
